...
const orderTypes = [
  ...
  { id: "TAKEAWAY", label: "Pick Up", icon: ShoppingBag },
] as const;
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-[#eef2f6] text-[#1e293b] overflow-hidden select-none font-sans">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-[420px] bg-white border-l border-[#cbd5e1] flex flex-col shrink-0 shadow-md">
          {/* Customer / Note Row */}
          <div className="p-1.5 border-b border-[#cbd5e1] flex items-center justify-between gap-2 bg-[#f8fafc]">
            <button
              type="button"
              onClick={() => setShowCustomerModal(true)}
              className="flex-1 flex items-center gap-1.5 px-2.5 py-1 rounded border border-slate-300 bg-white text-xs font-medium text-slate-700 hover:bg-slate-50 transition"
            >
              <User className="h-3.5 w-3.5 text-slate-500" />
              <span className="truncate">
                {customerName || customerPhone ? `${customerName || "Customer"} (${customerPhone})` : "+ Add Customer"}
              </span>
            </button>

            <div className="w-36 h-7 rounded border border-slate-300 bg-white px-2 flex items-center gap-1 focus-within:border-[#b82e46]">
          ...
          {/* Cart Subtotals, Action Buttons, Total Display, and Order Type/Payments */}
          <div className="p-2.5 bg-[#f8fafc] border-t border-[#cbd5e1] space-y-2 shrink-0">
            ...
            <div className="grid grid-cols-3 gap-1 pt-0.5">
              <button
                ...
                className="py-1.5 px-1 rounded bg-[#b82e46] hover:bg-[#a8253b] text-white font-bold text-xs shadow-2xs transition disabled:opacity-60"
              >
                Save
              </button>
              <button
              ...
              <button
                ...
                className="py-1.5 px-1 rounded bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-bold text-xs shadow-2xs transition disabled:opacity-60"
              >
                KOT
              </button>
              <button
                ...
                className="py-1.5 px-1 rounded bg-[#1e3a8a] hover:bg-[#172554] text-white font-bold text-xs shadow-2xs transition disabled:opacity-60"
              >
                KOT & Print
              </button>
              <button
                ...
                className="py-1.5 px-1 rounded bg-slate-600 hover:bg-slate-700 text-white font-bold text-xs shadow-2xs transition disabled:opacity-60"
              >
                Print
              </button>
            </div>
            ...
            {/* Grand Total Display */}
            <div className="flex items-center justify-between bg-slate-800 text-white p-2.5 rounded shadow-2xs">
            ...
            {/* BELOW TOTAL AMOUNT: Order Type Tabs (Dine In / Delivery / Pick Up) */}
            ...
            {/* BELOW TOTAL AMOUNT: Payment Options */}
