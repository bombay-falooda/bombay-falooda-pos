          ...
          <div className="w-full max-w-[350px]">
            ...
            <form onSubmit={onSubmit} className="rounded-[16px] border border-[#eadbd1] bg-white p-5 shadow-[0_20px_54px_rgba(42,32,27,0.09)]">
              ...
              <div className="my-4 flex items-center gap-4">
                ...
                <span className="text-xs font-semibold text-[#9b8d85]">or</span>
                <span className="h-px flex-1 bg-[#eadbd1]" />
              </div>

              <button type="button" className="flex h-9 w-full items-center justify-center gap-3 rounded-[9px] border border-[#eadbd1] bg-white text-xs font-bold text-[#5f4f47]">
                <span className="text-[#0f766e]">POS</span>
                Continue with terminal key
              </button>
